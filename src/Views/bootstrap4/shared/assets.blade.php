...
<script type="text/javascript">
    ...
    loadCSS({!! '"'.asset('https://cdn.datatables.net/v/bs4/dt-' . Juanrube\Ticketit\Helpers\Cdn::DataTables . '/r-' . Juanrube\Ticketit\Helpers\Cdn::DataTablesResponsive . '/datatables.min.css').'"' !!});
    @if($editor_enabled)
