                    ...
                    <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ action('\Juanrube\Ticketit\Controllers\DashboardController@index', 2) }}">
                                    {{ trans('ticketit::admin.index-3-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Juanrube\Ticketit\Controllers\DashboardController@index', 5) }}">
                                    {{ trans('ticketit::admin.index-6-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Juanrube\Ticketit\Controllers\DashboardController@index', 11) }}">
            ...
            <div class="col-lg-4 mt-3">
                ...
                <div class="tab-content">
                    ...
                    <div id="information-panel-agents" class="list-group tab-pane fade {{$active_tab == "agents" ? "show active" : ""}}">
                        ...
                        @endforeach
                        {!! $agents->render("pagination::bootstrap-5") !!}
                    </div>
